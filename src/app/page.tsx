    ...
    <div className="container fade-seq">
      ...
      <div className="home-bio">
        <p className="site-description site-opener">
          I&apos;m the co-founder and CTO of <a href="https://www.prototyping.io/" target="_blank" rel="noopener noreferrer">Prototyping.io</a> (YC P26) — an AI-driven manufacturing platform that analyzes CAD designs for manufacturability and automates production workflows, so engineers get high-quality parts faster and at lower cost.
        </p>
